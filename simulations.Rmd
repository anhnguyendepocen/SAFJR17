...
4- number of quadrature knots: \(35\), \(74\), \(105\).
...
s_an_vs_gq_summary <- s_an_vs_gq %>% 
  ...
  summarise(AF_convp = mean(AF_convergence == 0),
            ...
            AF_trt_empse = sqrt((1 / (n() - 1)) * sum(AF_trt - AF_trt_mean) ^ 2),
            GQ_trt_empse = sqrt((1 / (n() - 1)) * sum(GQ_trt - GQ_trt_mean) ^ 2),
            ...
            AF_theta_empse = sqrt((1 / (n() - 1)) * sum(AF_theta - AF_theta_mean) ^ 2),
            GQ_theta_empse = sqrt((1 / (n() - 1)) * sum(GQ_theta - GQ_theta_mean) ^ 2),
            ...
            AF_lambda_empse = sqrt((1 / (n() - 1)) * sum(AF_lambda - AF_lambda_mean) ^ 2),
            GQ_lambda_empse = sqrt((1 / (n() - 1)) * sum(GQ_lambda - GQ_lambda_mean) ^ 2),
            ...
            AF_p_empse = sqrt((1 / (n() - 1)) * sum(AF_p - AF_p_mean) ^ 2),
            GQ_p_empse = sqrt((1 / (n() - 1)) * sum(GQ_p - GQ_p_mean) ^ 2),
...
Proportion of simualtions converging:
