...
sidebar <- dashboardSidebar(
  sidebarMenu(
    ...
    menuItem("About simulation 1", tabName = "about_sim1"),
    menuItem("Simulation 2", tabName = "sim2"),
    menuItem("About simulation 2", tabName = "about_sim2"))
)
    ...
    tabItem(tabName = "sim1",
            ...
            fluidRow(
              ...
              box(
                ...
                hr(),
                selectInput("s1_par", "Parameter:", choices = c(Lambda = "lambda", P = "p", Theta = "theta", `Tr. effect` = "trt"), selected = "trt")
                )
              ),
            fluidRow(
              box(
